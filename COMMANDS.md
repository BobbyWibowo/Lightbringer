...
*Description:* Gives a random thing that happened today in history from [http://history.muffinlabs.com/date](http://history.muffinlabs.com/date)
...
*Description:* Convert currency using exchange rates from [http://fixer.io/](http://fixer.io/)
